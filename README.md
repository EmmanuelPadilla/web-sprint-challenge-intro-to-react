...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
   React solves the problem of working with large files and having to constantly update HTML. With REACT we can create components and styles to be updated independently of content. For example, if we have an API with 100 objects, instead of having 100 h2 tags, we can code 1 tag in our component and it will 'autofill' the headings so to sepeak.

2. Describe component state.
   The component state is where data lives before its rendered to the screen. It exists in memory waiting to be used or implimented.

3. Describe props.
   Props (properties) are OBJECTS that get passed to and fro, between different files.

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
   Side effects affect something outside of scope of the function being executed such as fetching data from APIs. some require clean up(usually a return statement), some dont.
